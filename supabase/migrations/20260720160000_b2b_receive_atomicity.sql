-- ============================================================================
-- ATOMICITÉ receive_b2b_purchase : les validations wallet 'on_reception' se font
-- APRÈS la boucle qui a déjà appliqué le STOCK et 'received_quantity'. Sous PostgREST,
-- un RETURN committe ce travail partiel → achat corrompu (stock reçu, jamais payé,
-- statut resté 'shipped'). On convertit ces 4 RETURN d'ERREUR en RAISE (rollback
-- complet). Le RETURN de SUCCÈS partiel (final=false) reste inchangé (commit voulu).
-- Le route /purchases/:id/receive parse déjà 'B2B_RECV:CODE'.
-- ============================================================================
